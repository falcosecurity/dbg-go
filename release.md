...
4. Once the CI has done its job, the tag is live on [Github](https://github.com/fededp/dbg-go/releases) with the artifacts, and the container image is live on [GHCR](ghcr.io/fededp/dbg-go).
